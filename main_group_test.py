    ...
    for r_w in opt.R_weight:
        ...
        for imageQF in opt.imageQFs:
            ...
            for idx_img in range(number_of_Image):
                ...
                patch_group, label = utils.patch_grouping(patchPairList,allpatch_glcm_feature,opt.n_clusters)
                ...
                for groupNum in range(len(patch_group)):
                    ...
                    if checkpoint.ok:
                        ...
                        ''' quantize weight '''
                        t.quantize_weight_v3()

                        ''' encode_quanWeight '''
                        encodedWeightBits = checkpoint.encode_quanWeight_pt(t)
