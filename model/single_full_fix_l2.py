...
class Net(nn.Module):
    def __init__(self):
        ...
        self.pre_trained = nn.Sequential(*list(model.features)[:3])
        ...
        self.conv1x1_1 = nn.Conv2d(in_channels=64, out_channels=16,
                                  kernel_size=1, stride=1, padding=0, bias=False, dilation=1, groups=16)
        self.conv1 = nn.Conv2d(in_channels=16, out_channels=16,
                                  kernel_size=3, stride=1, padding=1, bias=False, dilation=1, groups=16)
        self.IN1 = nn.InstanceNorm2d(16) 
        self.conv1x1_2 = nn.Conv2d(in_channels=16, out_channels=4,
                                  kernel_size=1, stride=1, padding=0, bias=False, dilation=1, groups=4)
        self.conv2 = nn.Conv2d(in_channels=4, out_channels=4,
                                  kernel_size=3, stride=1, padding=1, bias=False, dilation=1, groups=4)
                                #   kernel_size=3, stride=1, padding=2, bias=False, dilation=2, groups=self.baseChannel)
        self.IN2 = nn.InstanceNorm2d(4) 
        # self.conv1x1_3 = nn.Conv2d(in_channels=16, out_channels=8,
        #                           kernel_size=1, stride=1, padding=0, bias=False, dilation=1, groups=8)
        # self.conv3 = nn.Conv2d(in_channels=8, out_channels=8,
        #                           kernel_size=3, stride=1, padding=1, bias=False, dilation=1, groups=8)
        #                         #   kernel_size=3, stride=1, padding=5, bias=False, dilation=5, groups=self.baseChannel)
        # self.IN3 = nn.InstanceNorm2d(8) 
