...
class Net(nn.Module):
    def __init__(self):
        ...
        self.pre_trained = nn.Sequential(*list(model.features)[:3]).eval()
        ...
        self.conv1 = nn.Conv2d(in_channels=32, out_channels=32,
                                  kernel_size=3, stride=1, padding=1, bias=False, dilation=1, groups=(32//self.conv_g))
        self.IN1 = nn.InstanceNorm2d(32) 
        self.conv1x1_2 = nn.Conv2d(in_channels=32, out_channels=16,
                                  kernel_size=1, stride=1, padding=0, bias=False, dilation=1, groups=(16//self.conv_g))
        self.conv2 = nn.Conv2d(in_channels=16, out_channels=16,
                                  kernel_size=3, stride=1, padding=1, bias=False, dilation=1, groups=(16//self.conv_g))
        ...
        self.conv3 = nn.Conv2d(in_channels=8, out_channels=8,
                                  kernel_size=3, stride=1, padding=1, bias=False, dilation=1, groups=(8//self.conv_g))
